...
ShoppingList.create('olives', 3);

Recipes.create('pizza', ['sauce','cheese','pepperoni','crust']);
Recipes.create('cookies', ['cookie dough','chocalate chips']);
Recipes.create('ribs', ['meat','bbq sauce']);
